...
const projects = [
  {
    id: 1,
    name: 'FlutterMind AI',
    tech: ['Flutter', 'Dart', 'TensorFlow Lite', 'Firebase'],
    category: 'Mobile App',
    description:
      'A cross-platform mobile application that integrates on-device AI inference using TensorFlow Lite, providing real-time cognitive assistance and personalized learning recommendations.',
    features: [
      'On-device ML inference with TensorFlow Lite',
      'Real-time personalized learning pathways',
      'Firebase Firestore sync & offline mode',
      'Adaptive UI driven by user behavior analytics',
    ],
    icon: 'BrainCircuit',
  ...
  },
  {
    id: 2,
    name: 'AlgoVault',
    tech: ['C++', 'Python', 'Data Structures', 'Codeforces API'],
    category: 'Competitive Programming',
    description:
      'A curated problem-solving vault and performance tracker built for competitive programmers, aggregating problems across platforms with a personal analytics dashboard.',
    features: [
      'Multi-platform problem aggregation (Codeforces, LeetCode)',
      'Personal solve-rate analytics & streak tracking',
      'Topic-based filtering with difficulty heatmaps',
      'In-app editorial notes and solution bookmarking',
    ],
    icon: 'Code2',
  ...
  {
    id: 3,
    name: 'MediScan Flutter',
    tech: ['Flutter', 'Dart', 'ML Kit', 'REST API'],
    category: 'Mobile + AI',
    description:
      'A healthcare companion mobile app leveraging Google ML Kit for symptom scanning and medication recognition, with a clean Flutter-based UI and secure patient records.',
    features: [
      'Medication label OCR via Google ML Kit',
      'Symptom checker powered by medical REST API',
      'Secure patient record management with AES encryption',
  ...
  },
  {
    id: 4,
    name: 'Graph Sentinel',
    tech: ['C++', 'Graph Theory', 'Competitive Programming', 'STL'],
    category: 'Algorithms',
    description:
      'An advanced algorithmic toolkit focused on graph theory problems, implementing Dijkstra, Bellman-Ford, and flow algorithms with visualizable step-by-step execution traces.',
    features: [
      'Dijkstra & Bellman-Ford with path reconstruction',
      'Max-flow / min-cut via Dinic\'s algorithm',
      'Step-by-step execution trace export',
      'Competitive contest problem set bundled',
    ],
    icon: 'Network',
